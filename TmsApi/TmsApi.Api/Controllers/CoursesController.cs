...
public class CoursesController(
    ...
    LinkGenerator linkGenerator) : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCourseById(int id, CancellationToken ct)
        {
            ...
            // 1. Generate URLs safely using LinkGenerator and route names
            ...
            // 3. Conditional link: only allow enrolling if course is not full
            if (course.EnrollmentCount < course.MaxCapacity)
            {
                links.Add(new(enrollmentsUrl, "enroll", "POST"));
            }

            // 4. Return enriched detail contract
